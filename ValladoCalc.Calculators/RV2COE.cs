...
namespace ValladoCalc.Calculators
{
    public static class RV2COE
    {
        public static RV2COEResult Calculate(RV2COEModel data)
        {
            ...
            decimal[] angularMomentum = new decimal[]
            {
            ...
            decimal[] nodeVector = new decimal[]
            {
                -angularMomentum[1],
                angularMomentum[0],
            };
            ...
            decimal[] eccentricVectorPart1 = new decimal[]
            {
            ...
            decimal[] eccentricityVectorPart3 = new decimal[]
            {
            ...
            decimal[] eccentricityVectorPart4 = new decimal[]
            {
            ...
            decimal[] eccentricityVector = new decimal[]
            {
